    ...
    implements ActionListener
{
  ...
  {
	  switch(playerMove){
	  case('R'):if(computerMove=='P')return 1;
	  			else if(computerMove=='R')return 0;
	  			break;
	  case('P'):if(computerMove=='S')return 1;
	  			else if(computerMove=='P')return 0;
	  			break;
	  case('S'):if(computerMove=='R')return 1;
	  			else if(computerMove=='S')return 0;
	  			break;
	  }
	  return -1;
  }
